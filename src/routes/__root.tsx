...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Kenzo turns prompts into working web apps. Chat, edit, preview live — ship faster." },
      { name: "author", content: "Kenzo" },
      { property: "og:title", content: "Kenzo — Build web apps by chatting with AI" },
      { property: "og:description", content: "Chat, edit and preview live. Kenzo is the AI web builder." },
